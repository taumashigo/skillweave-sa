...
import {
  ...
  BookOpen, Briefcase, GraduationCap, Users, Shield, Heart,
} from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-gradient-to-br from-navy-700 via-navy-800 to-navy-900 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center px-16">
          ...
          <p className="text-base text-slate-300 max-w-sm mb-8">
            Create your account, choose your role, and start building personalised learning pathways that lead to real employment.
          </p>
          <div className="space-y-3">
            {[
              "NQF-aligned modular learning",
              "Drag-and-drop pathway builder",
              "QR-verifiable digital credentials",
              "Real employer-backed projects",
            ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-white">
        ...
        >
                ...
                {roles.map((role) => (
                  ...
                  >
                    <div className={cn(
                      ...
                      selectedRole === role.value ? "bg-emerald-100" : "bg-slate-100"
                    )}>
                      <role.icon className={cn(
                        "h-5 w-5",
                        selectedRole === role.value ? "text-emerald-600" : "text-slate-400"
                      )} />
                    </div>
                    <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input id="name" placeholder="Thabo Mokoena" className="pl-10" required value={fullName} onChange={(e) => setFullName(e.target.value)} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input id="password" type={showPassword ? "text" : "password"} placeholder="Min 8 characters" className="pl-10 pr-10" required value={password} onChange={(e) => setPassword(e.target.value)} />
                ...
                <div className="flex gap-3 pt-2">
                  <Button variant="outline" type="button" onClick={() => setStep(1)} className="w-24">
                    Back
                  </Button>
                  <Button type="submit" className="flex-1 h-11" isLoading={loading}>
                    Create Account
                    <ArrowRight className="h-4 w-4 ml-2" />
                  </Button>
                </div>
          ...
          <p className="text-center text-xs text-slate-400 mt-8">
            By signing up, you join {">"}5,000 South African learners building their futures.
          </p>
        </motion.div>
      </div>
    </div>
